...
<?php if ($with_voter) {?>use Symfony\Component\Security\Http\Attribute\IsGranted;<?php }?>   
...
<?php if ($with_voter) {?>#[IsGranted('<?= $voter_create ?>')]<?php }?>   
...
<?php if ($with_voter) {?>     #[IsGranted("view", subject:"<?= $entity_var_singular ?>", message:"crud.view.nogranted")]<?php }?>    
...
<?php if ($with_voter) {?>     #[IsGranted("edit", subject:"<?= $entity_var_singular ?>", message:"crud.edit.nogranted")]<?php }?>    
...
<?php if ($with_voter) {?>     #[IsGranted("delete", subject:"<?= $entity_var_singular ?>", message:"crud.delete.nogranted")]<?php }?>    
